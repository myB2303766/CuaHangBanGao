...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 05, 2026 lúc 08:04 PM
...
--
-- Cấu trúc bảng cho bảng `gia_quy_cach`
--
...
--
-- Đang đổ dữ liệu cho bảng `gia_quy_cach`
--
...
--
-- Cấu trúc bảng cho bảng `hinhanh_sp`
--
...
--
-- Đang đổ dữ liệu cho bảng `hinhanh_sp`
--
...
--
-- Cấu trúc bảng cho bảng `loaigao`
--
...
--
-- Đang đổ dữ liệu cho bảng `loaigao`
--
...
--
-- Cấu trúc đóng vai cho view `v_danhgia_sp`
...
--
-- Cấu trúc đóng vai cho view `v_doanhthu_thang`
-- (See below for the actual view)
--
...
--
-- Cấu trúc đóng vai cho view `v_sanpham_day_du`
-- (See below for the actual view)
--
...
--
-- Cấu trúc cho view `v_danhgia_sp`
--
...
--
-- Cấu trúc cho view `v_doanhthu_thang`
--
...
--
-- Cấu trúc cho view `v_sanpham_day_du`
--
...
--
-- AUTO_INCREMENT cho bảng `gia_quy_cach`
--
ALTER TABLE `gia_quy_cach`
...
--
-- AUTO_INCREMENT cho bảng `hinhanh_sp`
--
ALTER TABLE `hinhanh_sp`
...
--
-- Các ràng buộc cho bảng `gia_quy_cach`
--
ALTER TABLE `gia_quy_cach`
...
--
-- Các ràng buộc cho bảng `hinhanh_sp`
--
ALTER TABLE `hinhanh_sp`
