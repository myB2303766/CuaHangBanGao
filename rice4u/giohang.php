    ...
    <div class="cart-wrap">
      <div class="cart-list" id="cartList">
        <?php foreach ($cartItems as $item): ?>
          <?php
            ...
            $img = (string)($item['hinh'] ?? '/rice4u/asset/images/default.jpg');
          ?>
          <div class="cart-item" data-id="<?= htmlspecialchars($id) ?>" data-price="<?= $price ?>">
            <img src="<?= htmlspecialchars($img) ?>" alt="<?= htmlspecialchars($name) ?>" onerror="this.src='/rice4u/asset/images/default.jpg'">
            <div>
      ...
      <aside class="summary">
        ...
        <div style="margin-top:20px;padding-top:16px;border-top:1px solid #f0f0f0;">
          <a href="/rice4u/thanhtoan.php" class="btn-primary"
             style="display:flex;align-items:center;justify-content:center;gap:10px;width:100%;text-align:center;">
          ...
          <a href="/rice4u/sanpham.php"
             style="display:block;text-align:center;margin-top:12px;font-size:0.83rem;color:var(--text-mid);text-decoration:none;">
            ← Tiếp tục mua sắm
          </a>
        </div>
      </aside>
